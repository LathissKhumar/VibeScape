...
- [ ] 1. Test infrastructure setup (Vitest + RTL + Playwright)
...
- [ ] 2. Icon system standardization (material-symbols → lucide-react)
...
- [ ] 3. Create shared hooks (useMediaQuery, useReducedMotion, useWebGL)
...
- [ ] 4. Utility components (LoadingSkeleton, EmptyState, ErrorState, WebGLFallback)
...
- [ ] 5. Design system audit — CSS variable mapping stabilization
...
- [ ] 6. Baseline performance measurement + Lighthouse report
...
- [ ] 7. Split landing page (page.tsx) into section components
...
- [ ] 8. Hero section — cinematic redesign
...
- [ ] 9. Archetype cards showcase redesign
...
- [ ] 10. Galaxy preview section redesign
...
- [ ] 11. Mobile navigation + responsive layout
...
- [ ] 12. Smooth scroll + entrance animations
...
- [ ] 13. Split DashboardClient into section components
...
- [ ] 14. Personality engine hero redesign
...
- [ ] 15. Listening heatmap redesign ("3AM Sadness Spikes" style)
...
- [ ] 16. Audio features radar chart redesign
...
- [ ] 19. Dashboard loading, empty, and error states
...
- [ ] 20. WebGL detection + graceful 2D canvas fallback
...
- [ ] 21. Bloom post-processing + particle trails
...
- [ ] 22. Click-to-focus on planets + artist info popup
...
- [ ] 23. Genre constellations + orbital navigation
...
- [ ] 24. Camera transitions + animated artist connections
...
- [ ] 25. Shareable personality card enhancement
...
- [ ] 26. Friend comparison (lite — no backend)
...
- [ ] 27. Listening timeline (genre evolution + emotional transitions)
...
- [ ] 28. Micro-interactions + entrance animations
...
- [ ] 29. prefers-reduced-motion support across all animations
...
- [ ] 30. Accessibility pass (keyboard, ARIA, color contrast)
...
- [ ] 32. Performance optimization + bundle audit
